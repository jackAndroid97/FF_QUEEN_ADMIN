...
import com.ff_queen.admin.Activities.UsersActivity;
...
public class RetailerAdpater extends RecyclerView.Adapter<RetailerAdpater.ViewHolder> {
    ...
    public RetailerAdpater(Context context, List<View_User_Model> user_models) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.binding.btnView.setText("View User");
        ...
        holder.binding.btnView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Bundle b = new Bundle();
                b.putString("ref_code",user_models.get(position).getRef_code());
                context.startActivity(new Intent(context, UsersActivity.class).putExtras(b));
            }
        });
                ...
                new AlertDialog.Builder(context)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                changePassword(user_models.get(position).getRef_code(),"Retailer");
                            }
                        })
