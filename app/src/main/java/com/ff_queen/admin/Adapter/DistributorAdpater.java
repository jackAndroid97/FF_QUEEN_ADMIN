...
import com.ff_queen.admin.Activities.RetailerActivity;
...
public class DistributorAdpater extends RecyclerView.Adapter<DistributorAdpater.ViewHolder> {
    ...
    public DistributorAdpater(Context context, List<View_User_Model> user_models) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.binding.btnView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                context.startActivity(new Intent(context, RetailerActivity.class).putExtras(b));
            }
        });
                ...
                new AlertDialog.Builder(context)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                changePassword(user_models.get(position).getId(),"Distributor");
                            }
                        })
