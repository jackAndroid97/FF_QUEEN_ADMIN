...
public class UsersAdpater extends RecyclerView.Adapter<UsersAdpater.ViewHolder> {
    ...
    public UsersAdpater(Context context, List<View_User_Model> user_models) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (user_models.get(position).getEmail() !=null)
        {
            holder.binding.email.setText("Email ID : "+user_models.get(position).getEmail());
        }
        else
        {
            holder.binding.email.setText("No Email");
        }
                ...
                new AlertDialog.Builder(context)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                changePassword(user_models.get(position).getPhone(),"User");
                            }
                        })
